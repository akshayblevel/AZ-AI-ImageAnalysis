...
namespace AZ_AI_ImageAnalysis.Services
{
    public class VisionService : IVisionService
    {
        ...
        public async Task<string> DetectObjectsAsync(string imageUrl)
        {
            var uri = $"{_endpoint}computervision/imageanalysis:analyze" +
                      $"?api-version={_apiVersion}&features=objects";
        ...
        public async Task<string> ExtractTagsAsync(string imageUrl)
        {
            var uri = $"{_endpoint}computervision/imageanalysis:analyze" +
                      $"?api-version={_apiVersion}&features=tags";
